# -*- coding: utf-8 -*-
"""
Created on Thu Aug  5 15:51:31 2021
...
if __name__ == '__main__':
    X_train, y_train = load_datafromexcel(path = 'iris_2feature3label_train.xlsx')  #读取训练集数据
    X_train = X_train[:,:2]
    #测试集
    X_test, y_test = load_datafromexcel(path = 'iris_2feature3label_test.xlsx')  #读取测试集数据
    X_test = X_test[:,:2]    
    #训练模型 
