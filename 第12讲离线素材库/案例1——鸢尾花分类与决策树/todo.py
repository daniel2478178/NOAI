...
class RandomForest:
    def __init__(self, n_trees, max_depth = np.inf):
...
X_train, y_train = load_datafromcsv(path = '/Users/daniel/NOAI/第12讲离线素材库/案例1——鸢尾花分类与决策树/iris_2feature2label_train.csv')  #读取训练集数据
X_test, y_test = load_datafromcsv(path = '/Users/daniel/NOAI/第12讲离线素材库/案例1——鸢尾花分类与决策树/iris_2feature2label_test.csv')  #读取测试集数据
features = ['feature1','feature2']
dtree = DecisionTree(features)
dtree.fit( X_train, y_train)
predic = dtree.predict(X_test)
print("="*30+"Decision Tree Classification Report:"+"="*30)
print(classification_report(y_test, predic))
rf = RandomForest(n_trees=10, max_depth=5)
rf.fit(X_train, y_train)   
rf_predic = rf.predict(X_test)
print("="*30+"Random Forest Classification Report:"+"="*30)
